...
execute if score #trigonometry_math_0 dom.value matches ..-1 run scoreboard players operation #trigonometry_math_0 dom.value *= #-1 dom.value
scoreboard players remove #trigonometry_math_0 dom.value 900
